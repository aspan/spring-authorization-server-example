...
import com.example.core.security.oauth2.client.persistence.Oauth2ClientPersistenceConfiguration;

@Configuration
@Import(Oauth2ClientPersistenceConfiguration.class)
public class OAuth2ClientConfiguration {
    ...
    OAuth2ClientHttpRequestInterceptor oAuth2ClientHttpRequestInterceptor(
        ...
        interceptor.setClientRegistrationIdResolver(request -> environment.getProperty("example.client-registration-id", "hilla-client"));
